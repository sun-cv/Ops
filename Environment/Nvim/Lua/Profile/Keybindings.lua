...
vim.keymap.set("n", "<leader>fd",
    function() vim.cmd("cd " .. require("oil").get_current_dir()) end,                          { desc = "CD to current oil directory"})
...
-- Selection movement
vim.keymap.set("v", "<S-j>", ":m '>+1<cr>gv",                                                   { desc = "Move selection down", silent = true })
vim.keymap.set("v", "<S-k>", ":m '<-2<cr>gv",                                                   { desc = "Move selection up",   silent = true })
